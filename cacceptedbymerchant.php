...
$sql_header=array("Card Accepted", "Merchant Number");
...
$query="SELECT `fld_card_accepted`, `fld_merchant_no` FROM `tbl_merchant` WHERE `fld_merchant_no` in ($fld_merchant_no);";
